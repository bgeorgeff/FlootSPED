...
export const TeacherRoute = MakeProtectedRoute(["teacher", "admin"]);
export const ParentRoute = MakeProtectedRoute(["parent", "admin"]);
export const EducatorRoute = MakeProtectedRoute(["teacher", "parent", "admin"]);
export const StudentRoute = MakeProtectedRoute(["user", "admin"]);
